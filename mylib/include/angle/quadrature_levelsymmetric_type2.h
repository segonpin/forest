 ...
 * @file    angle/quadrature_levelsymmetric_type2.h
 * @brief   QuadratureLevelSymType2 class template declarations
 */

#ifndef FOREST_QUADRATURE_LEVELSYMMETRIC_TYPE2_H
#define FOREST_QUADRATURE_LEVELSYMMETRIC_TYPE2_H
...
{
  /**
   * @brief  QuadratureLevelSymType2
   * @ingroup ForestAngle
   */
  template <int dim>
  class QuadratureLevelSymType2 : public QuadratureBase<dim>
  {
  public:
    QuadratureLevelSymType2 (unsigned int order_);
